...
for i in range(0 , network_dime_x*network_dime_y):
	wave_file.write("add wave -noupdate -group {fault_sigs} :"+tb_name+":NoC:R_"+str(i)+":fault_out_N\n")
	wave_file.write("add wave -noupdate -group {fault_sigs} :"+tb_name+":NoC:R_"+str(i)+":fault_out_E\n")
