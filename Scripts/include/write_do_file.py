...
def write_do_file(program_argv, net_file_name, net_tb_file_name, wave_do_file_name, logging):
    ...
    if program_argv['add_FI']:
        for Fault_Per_Second in fault_per_second_list:

            links = generate_links_dictionary(program_argv['network_dime'], program_argv['sim'], Fault_Per_Second)

            generate_fault_injection_do(SIMUL_DIR, program_argv['sim'], program_argv['end'], links, Fault_Per_Second)
